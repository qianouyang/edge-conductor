...
var (
	...
	errInvalidSrc  = errors.New(ERRORCODE_SRC_FILE_INVALID)
	errInvalidDst  = errors.New(ERRORCODE_DST_FILE_INVALID)
	...
	errFileThere   = errors.New("File_exist")
)
