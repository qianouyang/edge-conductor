...
var (
	...
	errFileInv   = fmt.Errorf("File is not Valid")
	errFileDir   = fmt.Errorf("no such file or directory")
	errPortInv   = fmt.Errorf("Invalid containerPort")
	errContainer = fmt.Errorf("Container Not Found")
	errExitcode  = fmt.Errorf("Failed to get ExitCode of container")
	errAbnormal  = fmt.Errorf("Container exited abnormally")
)
