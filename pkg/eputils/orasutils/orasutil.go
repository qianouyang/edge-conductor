...
var (
	OrasCli                *OrasClient
	errFileEmpty           = fmt.Errorf("File path should not be empty")
	errOrasDefaultResolver = fmt.Errorf("Oras default resolver not found")
	errOrasResolver        = fmt.Errorf("Oras resolver not found")
)
