...
var (
	errFileExist      = errors.New("File_exist")
	errSrcInvalid     = errors.New(ERRORCODE_SRC_FILE_INVALID)
	errDstInvalid     = errors.New(ERRORCODE_DST_FILE_INVALID)
	errUnsupportedURL = errors.New(ERRORCODE_URL_SCHEME_NOT_SUPPORTED)
	errInvalidFile    = errors.New("File is not valid")
	errTgzUncompress  = errors.New("UncompressTgz: file not valid")
	errTgzHeader      = errors.New("UncompressTgz: unknown header type")
	errTarPath        = errors.New("The target tar file path is in the path directory.")
)
