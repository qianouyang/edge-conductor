...
var (
	...
	errParseExtension = errors.New("Parse extension service-tls error: Extension not found!")
	errParseConfig    = errors.New("Parse extension service-tls error: Config not found!")
)
...
func TestGenSvcTLSCertFromTLSExtension(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			expectErrorContent: errParseExtension,
		},
		{
			...
			expectErrorContent: errParseConfig,
		},
		{
