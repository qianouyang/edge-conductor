...
var (
	errExtNotFound     = errors.New("Parse extension " + SVCTLSEXT + " error: Extension not found!")
	errExtCfgNotFound  = errors.New("Parse extension " + SVCTLSEXT + " error: Config not found!")
	errCSRFileNotFound = errors.New("Service TLS error: CSR filename not found!")
)
