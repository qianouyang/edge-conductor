...
var (
	...
	errAuthServer = errors.New("input auth server address is empty")
	errProjName   = errors.New("input project name is empty")
	errAuthString = errors.New("auth string is empty")
	errHarborIP   = errors.New("input harbor IP is empty")
	errHarborPwd  = errors.New("input harbor password is empty")
...
func TestCreateHarborProject(t *testing.T) {
	...
	cases := []struct {
		...
		// TODO: Add test cases.
		{
			...
			expectErrorContent: errAuthServer,
		},
		{
			...
			expectErrorContent: errProjName,
		},
		{
			name: "authString_nil",
			args: args{
			...
			expectErrorContent: errAuthString,
		},
		{
			...
			expectErrorContent: errDay0CertFile,
		},
		{
...
func TestMapImageURLCreateHarborProject(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{
			...
			expectErrorContent: errHarborIP,
		},
		{
			...
			expectErrorContent: errHarborPort,
		},
		{
			...
			expectErrorContent: errHarborUser,
		},
		{
			...
			expectErrorContent: errHarborPwd,
		},
		{
