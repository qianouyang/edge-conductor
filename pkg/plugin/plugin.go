...
var (
	errInputSchema   = fmt.Errorf("Cannot find input schema")
	errFind          = fmt.Errorf("Cannot find")
	errGetLogStream  = fmt.Errorf("Get log stream error")
	errPluginConnect = fmt.Errorf("Plugin connection error")
)
