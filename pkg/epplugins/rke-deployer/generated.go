...
//nolint:deadcode,unused
func input_rkeconfig(in eputils.SchemaMapData) *pluginapi.Filecontent {
	return in[__name("rkeconfig")].(*pluginapi.Filecontent)
}
...
func init() {
	...
	Input[__name("rkeconfig")] = &pluginapi.Filecontent{}
