...
var (
	//errManifest = errors.New("Manifest for kind not found.")
	errManifest              = errors.New("Manifest not found.")
	errManifest_img_notfound = errors.New("Image not found.")
)
...
func TestPluginMain(t *testing.T) {
	var cases = []struct {
		...
		},
		{
			...
			expectedOutput: nil,
			expectError:    errManifest_img_notfound,
		},
		{
