...
var (
	errServiceStatus = fmt.Errorf("Helm service status")
	errUnknownStatus = fmt.Errorf("Helm service status unknown")
	errWrongStatus   = fmt.Errorf("Helm service with wrong status")
)
