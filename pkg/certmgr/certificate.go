...
var (
	errCertType = fmt.Errorf("Unsupported certificate type")
)
...
var (
	errCertDecodeFail  = errors.New("Failed to decode Cert")
	errInvalidFile     = errors.New("file is not valid")
	errCaCertIsDir     = errors.New("certbundle.Ca.Cert is a directory")
	errCaKeyIsDir      = errors.New("certbundle.Ca.Key is a directory")
	errServerCertIsDir = errors.New("certbundle.Server.Cert is a directory")
	errServerKeyIsDir  = errors.New("certbundle.Server.Key is a directory")
	errClientCertIsDir = errors.New("certcertbundle.Client.Cert is a directory")
	errClientKeyIsDir  = errors.New("certbundle.Client.Key is a directory")
	errCertNil         = errors.New("Cert path or Key path is nil")
	errKeyAlgo         = errors.New("Unsupported key algo ")
)
